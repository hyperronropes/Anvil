...
**Built with AI:** This fork was developed and maintained largely with AI-assisted coding (LLM pair-programming). Expect rough edges; review the source if you care how something works.

**Community:** [DeepCode Discord](https://discord.gg/8WU56Drt7F) — **not official Anvil support.** Anvil has no dedicated Discord server. The DeepCode server is a shared hangout where you can *ask questions*; there is no guarantee of Anvil-specific help, updates, or maintainer response.
...
use [GitHub issues](https://github.com/hyperronropes/Anvil/issues) or ask in the
[DeepCode Discord](https://discord.gg/8WU56Drt7F) (questions only — see [Support](#support)).
...
- **Questions (unofficial):** https://discord.gg/8WU56Drt7F — DeepCode Discord; not Anvil support, just a place to ask
...
- **Bugs / features (Anvil):** https://github.com/hyperronropes/Anvil/issues — preferred for Anvil-specific problems  
- **DeepCode Discord:** https://discord.gg/8WU56Drt7F — shared community chat; you can ask questions about Anvil but there is **no official support**, no Anvil-only channel guarantee, and no obligation for anyone to help. For reliable tracking, use GitHub issues.
